...
#define PanSource	"personal_fixing_ME.pml"
...
#define _nstates1	16	/* ProcessTwo */
#define minseq1	15
#define maxseq1	29
#define _endstate1	15

#define _nstates0	16	/* ProcessOne */
#define minseq0	0
#define maxseq0	14
...
#define PProcessTwo	((P1 *)_this)
typedef struct P1 { /* ProcessTwo */
...
#define PProcessOne	((P0 *)_this)
typedef struct P0 { /* ProcessOne */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct State {
	...
	unsigned wantOne : 1;
	unsigned wantTwo : 1;
	unsigned inCriticalSectionOne : 1;
	unsigned inCriticalSectionTwo : 1;
	uchar turn;
#ifdef TRIX
