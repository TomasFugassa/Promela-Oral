...
/*** From source: personal_fixing_ME.pml ***/
...
short src_ln1 [] = {
	  0,  29,  30,  31,  34,  33,  37,  37, 
	 38,  39,  41,  42,  28,  44,  28,  44, 
	  0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "personal_fixing_ME.pml", 1, 15 },
	{ "-", 16, 17 }
};
uchar reached1 [] = {
	  0,   1,   0,   0,   1,   0,   1,   0, 
...
short src_ln0 [] = {
	  0,  10,  11,  12,  15,  14,  18,  18, 
	 19,  20,  22,  23,   9,  25,   9,  25, 
	  0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "personal_fixing_ME.pml", 1, 15 },
...
iniglobals(int calling_pid)
{
		...
		now.turn = 1;
#ifdef VAR_RANGES
		logval("wantOne", now.wantOne);
		logval("wantTwo", now.wantTwo);
		logval("inCriticalSectionOne", now.inCriticalSectionOne);
		logval("inCriticalSectionTwo", now.inCriticalSectionTwo);
...
{	/* int i; */
	printf("global vars:\n");
	printf("	bit    wantOne:	%d\n", now.wantOne);
	printf("	bit    wantTwo:	%d\n", now.wantTwo);
	printf("	byte   turn:	%d\n", now.turn);
	printf("	bit    inCriticalSectionOne:	%d\n", now.inCriticalSectionOne);
	printf("	bit    inCriticalSectionTwo:	%d\n", now.inCriticalSectionTwo);
}
void
